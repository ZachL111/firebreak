"""Regression checks for the firebreak casebook."""
...
from casebook.harness import assert_expected, firebreak_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(firebreak_summary(), assert_expected())
